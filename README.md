...
This is a container that will run [dogs_breed_det](https://github.com/shramanpadhalni-web/dogs_breed_det) application leveraging the DEEP as a Service API component ([DEEPaaS API V2](https://github.com/indigo-dc/DEEPaaS)).
...
```bash
$ docker run -ti -p 5000:5000 -p 6006:6006 shramanpadhalni-web/deep-oc-dogs_breed_det
```
...
```bash
$ docker-compose up dogs_breed_det
```
...
1. Get the `DEEP-OC-dogs_breed_det` repository (this repo):
    ...
    ```bash
    $ git clone https://github.com/shramanpadhalni-web/DEEP-OC-dogs_breed_det
    ```
...
2. Build the container:
    ...
    $ docker build -t shramanpadhalni-web/deep-oc-dogs_breed_det .
    ```
